...
public abstract class VisualizationModule extends EeModule {
   ...
   * 
   * @param toolBarService the tool bar service to be added
   */
  public void addToolBarService(final Class<? extends ToolBarService> toolBarService) {
    final Multibinder<ToolBarService> multibinder =
        Multibinder.newSetBinder(binder(), ToolBarService.class);
   ...
   * @param toolBarService the tool bar service to be added
   */
  public static void addToolBarService(final Binder binder,
      final Class<? extends ToolBarService> toolBarService) {
    final Multibinder<ToolBarService> multibinder =
        Multibinder.newSetBinder(binder, ToolBarService.class);
    multibinder.addBinding().to(toolBarService);
  }
